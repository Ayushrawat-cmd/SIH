...
export default function Feeds(){
  ...
  {/* <a href="https://www.buymeacoffee.com/frankuxui" target="_blank" className='fixed top-8 right-8 z-50'><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style="height: 60px !important;width: 217px !important;" ></a> */}
  ...
  <div className="wrapper pt-10">
    ...
    {/* <!-- Content grid --> */}
    <div className="box-border max-w-7xl mx-4 sm:columns-1 md:columns-2 lg:columns-3 xl:columns-3 w-screen">
      {/* <!-- Card--> */}
      <article className=" break-inside-avoid-column mb-4 break-inside p-6 rounded-xl bg-white dark:bg-slate-800 flex flex-col bg-clip-border">
        ...
        <div className="my-4 flex gap-1">
          <div className="flex flex-col gap-1 flex-1">
            <a className="flex h-2/4" href="#">
              <img className="w-full h-full rounded-tl-lg object-cover"
                src="https://images.pexels.com/photos/327331/pexels-photo-327331.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" />
            </a>
            <a className="flex h-2/4" href="#">
              <img className="w-full rounded-bl-lg object-cover"
                src="https://images.pexels.com/photos/92866/pexels-photo-92866.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" />
            </a>
          </div>
          <div className="flex flex-col gap-1 flex-1">
            <a className="flex h-full" href="#">
              <img className="w-full rounded-tr-lg rounded-br-lg object-cover"
